...
file1 = './result/RDSGD/fault/20_q3/lam0.01_alpha0.1_sqrt/x_star_norm.txt'
file2 = './result/RDSGD/fault/20_q3/lam0.1_alpha0.1_sqrt/x_star_norm.txt'
file3 = './result/RDSGD/fault/20_q3/lam0.2_alpha0.1_sqrt/x_star_norm.txt'
file4 = './result/RDSGD/fault/20_q3/lam0.5_alpha0.05_sqrt/x_star_norm.txt'
# file1_1 = 'G:/python_code/byzantine/Krum/result?bgd/dist_data/machine20/alpha0.01_batch3/x_star_norm.txt'
# file3_1 =  './result/RDSGD/fault/20/alpha0.3_lam0.5_sqrt/x_star_norm.txt'

# file_no = './result/DSGD_param/fault/5/alpha0.1_sqrt/x_star_norm.txt'

lambda1_0_01 = file2list(file1)
lambda1_0_1 = file2list(file2)
lambda1_0_2 = file2list(file3)
lambda1_0_5 = file2list(file4)

# batch1 = file2list(file1_1)
# batch3 = file2list(file2_1)
...
fig1 = plt.figure(1)
plt.semilogy(np.arange(num_iter), lambda1_0_01, color='green', label='lambda_0.01')
plt.semilogy(np.arange(num_iter), lambda1_0_1, color='red', label='lambda_0.1')
plt.semilogy(np.arange(num_iter), lambda1_0_2, color='blue', label='lambda_0.2')
plt.semilogy(np.arange(num_iter), lambda1_0_5, color='purple', label='lambda_0.5')
# plt.semilogy(np.arange(num_iter), batch1, color='yellow', linestyle='-', label='batch1')
# plt.semilogy(np.arange(num_iter), batch3, color='black', linestyle='-', label='batch3')
...
# fig1 = plt.figure(1)
# plt.semilogy(np.arange(num_iter), lambda1_0_01, color='green', label='lambda_0.01')
# plt.semilogy(np.arange(num_iter), lambda1_0_1, color='red', label='lambda_0.2')
# plt.semilogy(np.arange(num_iter), lambda1_0_2, color='blue', label='lambda_0.5')
